...
const Nav = () => {
  ...
  return (
    <nav>
      <a href="https://olamidemusodiqportfolio.netlify.app#"  onClick={() => setActiveNav('https://olamidemusodiqportfolio.netlify.app#')} className={activeNav === 'https://olamidemusodiqportfolio.netlify.app#' ? 'active' : ''} rel="noopener noreferrer"><AiOutlineHome/></a>
